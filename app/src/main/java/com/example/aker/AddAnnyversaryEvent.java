...
// Debug line below
	...
	public void contactSelection(String evid) {
		Intent inttbl = new Intent(getBaseContext(), PhoneContactRevised.class);	// PhoneContact.class
